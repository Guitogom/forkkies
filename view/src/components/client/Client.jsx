        ...
        <main className="client-app" style={{ backgroundColor: themeColor }}>
            ...
            <div className="client-screen" >
                <Routes>
                    ...
                    <Route path='/c/:categoryId/sp/:productId/s' element={<ClientStepHandler categories={template.categories} secondaryColor={secondaryColor} themeColor={themeColor} primaryColor={primaryColor} />} />
