...
export function ClientFooter({ primaryColor, secondaryColor, callToActionColor, themeColor, orderPrice, cart }) {
    const { tag } = useParams()
    ...
    const payButton = (
        <button className="client-order" onClick={handlePay} style={{ backgroundColor: secondaryColor, color: themeColor }}>
